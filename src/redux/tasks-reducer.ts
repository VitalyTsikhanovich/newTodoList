...
export const setTaskTitleAC = (tasks: Array<TaskType>, todoListIs: string) => ({type: 'SET-TASK', tasks, todoListIs} as const)
...
export type setTaskTitleACType = ReturnType<typeof setTaskTitleAC>
